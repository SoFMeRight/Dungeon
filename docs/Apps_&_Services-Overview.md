...
✅ 110 healthy · ⚠️ 2 degraded · ❌ 2 down
...
**Zitadel — 3 components** — StatefulSet — v4.17.0
- Namespace: zeldas-lullaby
- Replicas: 3/3
...
**Zitadel Login V2** — Deployment — v4.17.0
- Namespace: zeldas-lullaby
- Replicas: 3/3
- Hosts: sso.prplanit.com
- Gateway: cell-membrane-gateway
